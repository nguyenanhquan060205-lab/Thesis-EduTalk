    ...
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      <div className={cn("flex items-center justify-center [perspective:1000px]", containerClassName)}>
        <div
          ...
          className={cn(
            "relative transition-all duration-200 ease-out [transform-style:preserve-3d]",
            className
          )}
        >
          {children}
...
export const CardBody = ({
  ...
  return (
    <div
      className={cn(
        "h-auto w-full [transform-style:preserve-3d] rounded-2xl border border-slate-200/80 bg-white/90 p-6 backdrop-blur-xl shadow-md transition-shadow hover:shadow-xl",
        className
      )}
    >
      {children}
