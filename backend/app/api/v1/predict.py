...
class SurveySubmit(BaseModel):
    scores: list[int] = Field(
        ...
        min_length=10, 
        max_length=10, 
        description="10 scores from survey: [Năng động, Hướng nội, Sáng tạo, Logic, Tò mò, Cảm thông, Công nghệ, Xã hội, Sức khỏe, Nghệ thuật]"
    )
...
@router.post("/", response_model=PredictionResponse, summary="Predict suitable majors")
